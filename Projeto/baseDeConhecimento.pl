...
contrato(1,700000000,300000000,'Aquisição de Serviços','Consulta Previa','Fornecimento de petrólio',50000,365,'Lisboa',"01-01-2018"). % CP-PETROGAL
contrato(2,700000000,700000005,'Aquisição de Serviços','Ajuste Direto','contrato de intermediação financeira',25000,366,'Lisboa',"01-04-2020"). % CP-CGD
contrato(3,700000001,300000006,'Aquisição de Serviços','Concurso Público','Controlo das portagens ',100000,365,'Lisboa',"06-01-2010"). % BRISA-PRIO
contrato(4,700000004,300000001,'Aquisição de Serviços','Consulta Previa','Fornecimento de energia',100000,365,'Viana do Castelo',"06-01-2013"). % ULSAM-EDP
contrato(5,700000004,300000004,'Aquisição de Serviços','Concurso Público','Fornecimento de Gas Natural ',30000,365,'Viana do Castelo',"03-01-2010"). % ULSAM-GALP
contrato(6,700000003,300000003,'Aquisição de Serviços','Concurso Público','Controlo do trafego aerio ',5000000,1096,'Lisboa',"06-01-2017"). % NAV-TAP
...
contrato(8,700000006,300000005,'Aquisição de Serviços','Ajuste Direto','Distribuicao de correio',3000,365,'Porto',"06-01-2020"). % PME-CTT
contrato(9,700000006,700000004,'Aquisição de Serviços','Consulta Previa','Compra de protecoes contra o Covid19',50000,180,'Lisboa',"01-02-2019"). % PME-ULSAM
